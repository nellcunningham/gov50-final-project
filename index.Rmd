...
top_position_spread <- players |>
  ...
  labs(title = "Position Spread for Players with Positive Overall Efficiency Scores", x = "Player Position", y = "Count")
top_position_spread
```
...
rap_plot <- pos_mean |>
  ...
  geom_col(fill = "coral") +
  labs(title = "Average Efficiency Score By Player Position", caption = "*only mapping players with a positive efficiency score", x = "Player Position", y = "Average Efficiency Score")
rap_plot
```
