...
position_spread <- players |>
  ...
  labs(title = "Position Spread for All Players", x = "Player Position", y = "Count")
position_spread
```
```{r}
prop <- players |>
